...
int16_t aTxBuffer[] = {0,10,-10,10,-10,10,-10,10,-10,10,-10};
...
int16_t aRxBuffer[11];

/* Default variabel for 3 array */
#ifndef MASTER_BOARD
int16_t res1[10] = {1,-1,11,-11,4,-4,44,-44,7,-7};
int16_t res2[10] = {2,-2,22,-22,5,-5,55,-55,8,-8};
int16_t res3[10] = {3,-3,33,-33,6,-6,66,-66,9,-9};
#endif
